...
class ParentList extends Component {
  ...
  delete = () => {
    ...
    Api("parents/" + this.state.deleteItem, "delete")
      .then((response) => {
  ...
  render() {
        ...
        Cell: (props) => {
          ...
          return (
            <span className="">
              <Link
                to={{
                  pathname: "/viewParent/" + props.value,
                  state: {
                    search: props.value,
                  },
                }}
              ...
              <Link
                to={{
                  pathname: "/editParent/" + props.value,
                  state: {
                    search: props.value,
                  },
                }}
    ...
    let parentData = this.state.parent,
      searchString = this.state.searchString.trim().toLowerCase();
    if (searchString.length > 0) {
      parentData = this.state.parent.filter((l) => {
